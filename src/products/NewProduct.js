...
class NewProduct extends Component {
    ...
    render() {
        ...
        return <div className="container col-4 m-3">
            ...
            <ShouldRender condition={loader}>    <Loader />  </ShouldRender>
            <ShouldRender condition={hasError}>  <Error />   </ShouldRender>
            ...
            <form onSubmit={this.onSave}>
                ...
                <hr />
                <button type="submit" disabled={!brand || !model || !price || !discount}
